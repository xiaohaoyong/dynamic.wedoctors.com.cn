...
class AreaSelect
{
    ...
    public static function data($str = 0, $key = NULL)
    {
        $area_array = [];
        $sub_array = [];
        ...
        $sub_array[50][5040] = "石柱县";
        $sub_array[50][5041] = "秀山县";
        $sub_array[50][5042] = "酉阳县";
        $sub_array[50][5043] = "彭水县";
        ...
        if ($key !== NULL)
        {
            return empty($var[$key]) ? 0 : $var[$key];
        }
    ...
    {
        return AreaSelect::data('area_array');
    }

    public static function citys($key)
    {
        return AreaSelect::data('sub_array', $key);
    }

    public static function districts($key)
    {
        return AreaSelect::data('sub_arr', $key);
    }

    public static function getName($id,$pid)
    {
        if (!empty($pid))
        {
            $city = AreaSelect::citys($pid);
            return $city[$id];
        }else{
            $province = AreaSelect::provinces();
            return $province[$id];
        }
    }

    public static function getParentId($id,$level = 3)
    {
        $data = AreaSelect::districts();
